...
function isBudgetEnough (obj) {
    ...
    let allArea = 0;
    let moneyPerMonth;
    obj.shops.forEach(function(item, i){
        let m = 0;
        allArea += Object.values(item)[m] * Object.values(item)[++m] ;
        console.log(allArea);

   });
   moneyPerMonth = allArea * obj.height * obj.moneyPer1m3;
   console.log(moneyPerMonth);
   if(moneyPerMonth <= obj.budget) {
